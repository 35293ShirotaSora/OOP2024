...
namespace SampleWeightUnitConverter {
    public class MainWindowViewModel : ViewModel{
        ...
        public MainWindowViewModel(){
            ...
            GramToPoundUnit = new DelegateCommand(() => PoundValue = CurrentPoundUnit.FromGramUnit(CurrentGramUnit,GramValue));

            PoundUnitToGram = new DelegateCommand(() => GramValue = CurrentGramUnit.FromPoundUnit(CurrentPoundUnit, PoundValue));
        }
    }
}
